...
Rails.application.configure do
  ...
  # Account email confirmation feature toggle (T010).
  # Default: false in development — users can sign in without confirming their email locally.
  # Override via ENV: ACCOUNT_EMAIL_CONFIRMATION_ENABLED=true
  # Override via credentials: features.account_email_confirmation_enabled
