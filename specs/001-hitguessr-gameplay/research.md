...
**Decision**: Utiliser SQLite par défaut avec la configuration Rails 8 standard.
...
**Decision**: Utiliser Devise 5.x avec configuration Hotwire/Turbo intégrée.
...
| Clearance                   | Moins de fonctionnalités, communauté petite   |
...
**Decision**: Utiliser `tailwindcss-rails` gem (v4.x) - sans Node.js.
...
**Decision**: Utiliser un enum Rails simple avec méthodes de transition custom.
...
**Decision**: Validation de scope ActiveRecord avec normalisation d'URL.
