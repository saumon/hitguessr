...
| url        | string   | NOT NULL             | Lien musical (YouTube...) |
| created_at | datetime | NOT NULL             |                           |
| updated_at | datetime | NOT NULL             |                           |
...
| proposal_id       | bigint   | FK (proposals), NOT NULL | Proposition        |
...
| FR-004: Une proposition/joueur    | Unique index `[game_id, player_id]`           |
